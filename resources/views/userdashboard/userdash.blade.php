    ...
    <nav class="navbar navbar-expand-lg navbar-dark " style="background-color: rgba(9, 13, 241, 0.74)">
      ...
      <div class="container mt-4">
        <div class="row" >
            <div class="col-lg-4 ">
                <h2>PERSBOOK</h2>
                <a href="/register" class="btn btn-warning">Ayo Daftar Sekarang!!</a>
            </div>
            ...
            <div class="row ms-5">
              ...
              <div class="col-3">
                <div class="card" style="width: 18rem;">
                  <img src="../assets/img/{{$cd->foto}}" class="card-img-top" alt="...">
                  <div class="card-body">
                    <p class="card-text">Title: {{$cd->title}}</p>
                    <p class="card-text">Release: {{$cd->release}}</p>
                    <p class="card-text">Upload: {{$cd->date}}</p>
                    <a href="#" class="btn btn-outline-success">Baca sekarang</a>
                  </div>
                </div>
              </div>
              @endforeach
